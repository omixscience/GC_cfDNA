...
## 3.3 join
```{r}
# join_Clinical <- left_join(Clinical, data_length, by = c("Sample" = "Sample"))
...
```{r}
summary(join_EVD_data_Clinical[join_EVD_data_Clinical$Group_predicted=="Non-GC",]$predicted_prob)
summary(join_EVD_data_Clinical[join_EVD_data_Clinical$Group_predicted=="GC",]$predicted_prob)
p <- wilcox.test(join_EVD_data_Clinical[join_EVD_data_Clinical$Group_predicted=="Non-GC",]$predicted_prob,join_EVD_data_Clinical[join_EVD_data_Clinical$Group_predicted=="GC",]$predicted_prob)
p$p.value

boxplot_CancerScore <- data.frame(join_EVD_data_Clinical) %>%
...
pdf("20240925_cfDNA_03_Cancer_score_boxplot_v1.pdf", height=5.5, width=5.5)

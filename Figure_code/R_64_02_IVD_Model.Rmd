...
Model_20_DLA <- IVD_data

Model_02_GLM <- read.xlsx("/Users/xuewei/ZxProjects/20240408_GC_cfDNA/202409/64_Model/GC_20240926_model/02_GLM/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_02_GLM)<-c("predicted", "predicted_prob", "actual", "Sample")

Model_03_SVM <- read.xlsx("/Users/xuewei/ZxProjects/20240408_GC_cfDNA/202409/64_Model/GC_20240926_model/03_SVM/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_03_SVM)<-c("predicted", "predicted_prob", "actual", "Sample")

Model_04_RFC <- read.xlsx("/Users/xuewei/ZxProjects/20240408_GC_cfDNA/202409/64_Model/GC_20240926_model/04_RFC/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_04_RFC)<-c("predicted", "predicted_prob", "actual", "Sample")

Model_07_XGBoost <- read.xlsx("/Users/xuewei/ZxProjects/20240408_GC_cfDNA/202409/64_Model/GC_20240926_model/07_XGBoost/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_07_XGBoost)<-c("predicted", "predicted_prob", "actual", "Sample")

Model_08_LightGBM <- read.xlsx("/Users/xuewei/ZxProjects/20240408_GC_cfDNA/202409/64_Model/GC_20240926_model/08_LightGBM/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
...
pdf('20240926_02_Internal_validation_ROC_v1.pdf', width = 8, height = 6)
# 绘制图形
...
## 4.3 plot2
```{r}
pdf('20240926_02_Internal_validation_ROC_v2.pdf', width = 8, height = 6)

...
# EVD_data <- read.xlsx("/Users/xuewei/ZxProjects/20240408_GC_cfDNA/22_AUC/Top100_features/External_val.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
...
pdf('20240925_01_Stage_I_ROC_IVD_v1.pdf', width = 8, height = 6)
tibble(x=perf_roc@x.values[[1]], y=perf_roc@y.values[[1]]) %>%
ggplot(aes(x=x, y=y)) + 
...
pdf('20240925_02_Stage_II_ROC_IVD_v1.pdf', width = 8, height = 6)
tibble(x=perf_roc@x.values[[1]], y=perf_roc@y.values[[1]]) %>%
ggplot(aes(x=x, y=y)) + 
  # geom_line(aes(color=cut(y, c(-1,0.5,0.7,0.9,1))), linewidth=2) +
  # geom_point(aes(color=cut(y, c(-1,0.5,0.7,0.9,1))), size = 3) +
...
pdf('20240925_03_Stage_III_ROC_IVD_v1.pdf', width = 8, height = 6)
tibble(x=perf_roc@x.values[[1]], y=perf_roc@y.values[[1]]) %>%
ggplot(aes(x=x, y=y)) + 
  # geom_line(aes(color=cut(y, c(-1,0.5,0.7,0.9,1))), linewidth=2) +
  # geom_point(aes(color=cut(y, c(-1,0.5,0.7,0.9,1))), size = 3) +
...
pdf('20240925_04_Stage_IV_ROC_IVD_v1.pdf', width = 8, height = 6)
tibble(x=perf_roc@x.values[[1]], y=perf_roc@y.values[[1]]) %>%
ggplot(aes(x=x, y=y)) + 
  # geom_line(aes(color=cut(y, c(-1,0.5,0.7,0.9,1))), linewidth=2) +
  # geom_point(aes(color=cut(y, c(-1,0.5,0.7,0.9,1))), size = 3) +
...
ggsave("20240925_05_Stage_CancerScore_barplot_IVD_v1.png", plot_summary_stats, height=4.5, width=6, dpi = 300)

```

## 9.2 boxplot
```{r}
pdf("20240925_06_Stage_Cancer_score_barplot_IVD_v1.pdf", height=6, width=8)
